    ...
    >
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
            ...
            <div className="mb-12 lg:mb-0 lg:flex-col">
                ...
                Let's turn data into impact, if you're working on something bold in analytics, ML, or cloud, I'd love to collaborate and build something brilliant together!
                </p>
                ...
                <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            autoComplete="email"
                            required
                            placeholder="tejas2000930@gmail.com"
                            className="text-field reveal-up"
                        />
                    </div>
